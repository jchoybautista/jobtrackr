...
const SPECS: DemoSpec[] = [
  ...
  { key: "framer", company: "Framer", role: "Design Engineer", stageId: "stage-saved",
    created: 5, silent: 5, location: "Amsterdam", workMode: "hybrid", source: "Company site",
    salaryMin: 90000, salaryMax: 110000, currency: "EUR", furthestStageId: "stage-saved" },
  { key: "duolingo", company: "Duolingo", role: "Web Engineer", stageId: "stage-saved",
    created: 6, silent: 6, location: "New York", workMode: "hybrid", source: "Wellfound",
    salaryMin: 140000, salaryMax: 175000, currency: "USD", furthestStageId: "stage-saved" },
  { key: "spotify", company: "Spotify", role: "Frontend Engineer II", stageId: "stage-saved",
    created: 8, silent: 8, location: "Stockholm", workMode: "onsite", source: "LinkedIn",
    tagIds: ["tag-low"], furthestStageId: "stage-saved" },
  { key: "sentry", company: "Sentry", role: "Software Engineer", stageId: "stage-saved",
    created: 9, silent: 9, location: "Remote", workMode: "remote", source: "Hacker News",
    salaryMin: 160000, salaryMax: 185000, currency: "USD", tagIds: ["tag-remote"],
    furthestStageId: "stage-saved" },
  ...
  { key: "airbnb", company: "Airbnb", role: "Senior Product Engineer", stageId: "stage-screening",
    created: 16, applied: 13, silent: 5, location: "Remote · US", workMode: "remote",
    source: "LinkedIn", salaryMin: 190000, salaryMax: 230000, currency: "USD",
    tagIds: ["tag-high", "tag-remote"], furthestStageId: "stage-screening" },
  { key: "zalora", company: "ZALORA", role: "Senior Web Engineer", stageId: "stage-screening",
    created: 14, applied: 11, silent: 4, location: "Singapore", workMode: "onsite",
    source: "JobStreet", salaryMin: 8000, salaryMax: 10000, currency: "SGD",
    tagIds: ["tag-onsite"], furthestStageId: "stage-screening" },
  ...
  { key: "atlassian", company: "Atlassian", role: "Frontend Developer", stageId: "stage-interview",
    created: 26, applied: 22, silent: 6, location: "Sydney · Remote AU", workMode: "remote",
    source: "LinkedIn", salaryMin: 140000, salaryMax: 170000, currency: "AUD",
    furthestStageId: "stage-interview" },
  ...
  { key: "loom", company: "Loom", role: "Design Technologist", stageId: "stage-technical",
    created: 42, applied: 38, silent: 6, location: "Remote", workMode: "remote", source: "Wellfound",
    salaryMin: 150000, salaryMax: 180000, currency: "USD", furthestStageId: "stage-technical" },
  ...
  { key: "shopify", company: "Shopify", role: "Web Developer", stageId: "stage-offer",
    ...
    furthestStageId: "stage-final" },
  { key: "automattic", company: "Automattic", role: "JavaScript Engineer", stageId: "stage-offer",
    created: 47, applied: 43, silent: 4, location: "Remote · Anywhere", workMode: "remote",
    source: "Company site", salaryMin: 145000, salaryMax: 165000, currency: "USD",
    tagIds: ["tag-remote"], furthestStageId: "stage-final" },
  ...
  { key: "sprout", company: "Sprout Solutions", role: "Full Stack Developer", stageId: "stage-rejected",
    created: 60, applied: 56, silent: 33, location: "Manila", workMode: "onsite", source: "JobStreet",
    salaryMin: 130000, salaryMax: 170000, currency: "PHP", furthestStageId: "stage-interview" },
  { key: "google", company: "Google", role: "Software Engineer III", stageId: "stage-rejected",
    ...
    furthestStageId: "stage-screening" },
  { key: "microsoft", company: "Microsoft", role: "Software Engineer II", stageId: "stage-rejected",
    created: 52, applied: 48, silent: 25, location: "Remote · US", workMode: "remote",
    source: "LinkedIn", salaryMin: 160000, salaryMax: 190000, currency: "USD",
    furthestStageId: "stage-screening" },
  { key: "lalamove", company: "Lalamove", role: "Web Engineer", stageId: "stage-rejected",
    created: 57, applied: 53, silent: 30, location: "Manila", workMode: "hybrid", source: "JobStreet",
    salaryMin: 120000, salaryMax: 150000, currency: "PHP", furthestStageId: "stage-screening" },
...
function buildInterviews(now: Date): Interview[] {
  const rows: [key: string, round: Interview["roundType"], inDays: number, where: string, notes?: string][] = [
    ...
    ["atlassian", "panel", 9, "Zoom · Sydney time", "Early morning Manila time — 7:00."],
...
const CONTACTS: [key: string, name: string, role: string, email: string, linkedin?: string][] = [
  ...
  ["airbnb", "Yuki Tanaka", "Recruiter", "yuki.tanaka@example.com"],
  ...
  ["automattic", "Peter Vance", "Matt's team · Recruiter", "peter.vance@example.com"],
];
