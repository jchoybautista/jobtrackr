...
const linkSecondaryMd = `${pillBase} border border-line bg-surface text-ink hover:bg-sunken text-base font-semibold px-5 h-10`;
const linkPrimaryMd = `${pillBase} bg-ink text-white hover:opacity-85 text-base font-semibold px-5 h-10`;
const linkSecondarySm = `${pillBase} flex-1 border border-line bg-surface text-ink hover:bg-sunken text-sm font-semibold px-3.5 h-8`;
    ...
    <li className="flex flex-col gap-3 rounded-2xl border border-line-2 bg-surface p-4">
      ...
      <div className="flex flex-col gap-1">
        <input
          ...
          className="w-full rounded-lg bg-transparent px-1 py-0.5 text-base font-bold hover:bg-sunken focus:bg-sunken focus:outline-2 focus:outline-ink"
        />
        <div className="flex flex-wrap items-center gap-1.5 px-1">
          <span className="text-sm text-ink-3">{template.name}</span>
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} title="Delete CV" maxWidth="max-w-sm">
        <p className="mb-5 text-base text-ink-2">
    ...
    <div className="mx-auto max-w-5xl px-5 pt-6 lg:px-7">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-ink-3">Tailored CVs from your master profile</p>
        </div>
      ...
      {!hasProfile ? (
        <div className="rounded-2xl border border-dashed border-line bg-surface px-6 py-12 text-center">
          ...
          <p className="mx-auto mt-1 mb-5 max-w-md text-base text-ink-3">
